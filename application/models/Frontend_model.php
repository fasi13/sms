...
class Frontend_model extends CI_Model {
    ...
    function update_terms_conditions() {
      $data['description']  = html_escape($this->input->post('terms_conditions'));
    ...
    function update_privacy_policy() {
      $data['description']  = html_escape($this->input->post('privacy_policy'));
    ...
    function update_about_us() {
      $data['description']  = html_escape($this->input->post('about_us'));
    ...
    function update_frontend_general_settings() {
      $data['description']  = html_escape($this->input->post('school_title'));
      $this->db->where('type', 'school_title');
      $this->db->update('frontend_general_settings', $data);

      $data['description']  = html_escape($this->input->post('email'));
      ...
      $data['description']  = html_escape($this->input->post('fax'));
      $this->db->where('type', 'fax');
      $this->db->update('frontend_general_settings', $data);

      $data['description']  = html_escape($this->input->post('copyright_text'));
      ...
      $data['description']  = html_escape($this->input->post('school_location'));
      $this->db->where('type', 'school_location');
      $this->db->update('frontend_general_settings', $data);

      $data['description']  = html_escape($this->input->post('homepage_note_title'));
      $this->db->where('type', 'homepage_note_title');
      $this->db->update('frontend_general_settings', $data);

      $data['description']  = html_escape($this->input->post('homepage_note_description'));
      $this->db->where('type', 'homepage_note_description');
      $this->db->update('frontend_general_settings', $data);

      $data['description']  = html_escape($this->input->post('recaptcha_site_key'));
      ...
      $social['google'] = html_escape($this->input->post('google'));
      $social['youtube'] = html_escape($this->input->post('youtube'));
      $social['instagram'] = html_escape($this->input->post('instagram'));
